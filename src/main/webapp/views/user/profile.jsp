		...
		<div class="row">
			<div class="col-md-3 border-right">
				<div
					...
					<c:if test="${sessionScope.url_image != null}">
						<img class="rounded-circle mt-5" width="150px"
							src="${sessionScope.url_image}">

					</c:if>
					<c:if test="${sessionScope.url_image == null}">
						<c:url value="${sessionScope.userAccount.images}" var="imgUrl"></c:url>

					</c:if>
					<span> <a href="/ltweb_weekly_proj/cloudinaryUpload"
						class="btn btn-info" role="button">Upload ảnh</a>
					</span>
